...
- [`docs/DOMAIN.md`](./docs/DOMAIN.md) — 도메인 객체 6개, 상태 전이, 트라이아지·클러스터 룰.
- [`docs/DESIGN.md`](./docs/DESIGN.md) — 단순함의 디자인 철학과 5개 원칙.
- [`docs/CONVENTIONS.md`](./docs/CONVENTIONS.md) — 코드·카피·네이밍 컨벤션.
- [`docs/ROADMAP.md`](./docs/ROADMAP.md) — Phase 0–13 개발 로드맵 + 백로그 + 의사결정 일지.
...
- 모바일 반응형 (데스크톱 1280px+ 우선)
- 다국어 지원 (한국어만)
- 다중 워크스페이스 / 권한 / 빌링 모델 (단일 사용자 가정)
- 자체 코드 에디터·IDE
- 비-GitHub 호스팅 (GitLab/Bitbucket 등) — 어댑터 확장 가능성은 열어둠

> 위 항목은 의도적으로 안 만듦. 자세한 단계별 비-목표 는 `docs/ROADMAP.md` 참조.
