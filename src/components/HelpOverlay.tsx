...
const SCREENS = [
  ...
  { key: 'work', label: t.nav.work, desc: t.help.screens.work },
  { key: 'issues', label: `${t.nav.work} ▸ ${t.nav.issues}`, desc: t.help.screens.issues },
  { key: 'todos', label: `${t.nav.work} ▸ ${t.nav.todos}`, desc: t.help.screens.todos },
